...
$user_id = "24913"; // string | API User ID - Can be found in your settings page.
$api_key = "hOwi9wBiVHytDSXGx5Di"; // string | API Key - Can be found in your settings page.
$message = "Your payment has been received. Thank you for joining us."; // string | Text of the message. 320 chars max.
$to = "94711194313"; // string | Number to send the SMS. Better to use 9471XXXXXXX format.
...
try {
    ...
    header("Location: https://site.test");
} catch (Exception $e) {
